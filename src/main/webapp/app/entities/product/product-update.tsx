  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="merlionBonusTrackApp.product.home.createOrEditLabel">
            <Translate contentKey="merlionBonusTrackApp.product.home.createOrEditLabel">Create or edit a Product</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">

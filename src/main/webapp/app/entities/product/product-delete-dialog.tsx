...
export const ProductDeleteDialog = (props: IProductDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="merlionBonusTrackApp.product.delete.question">
        <Translate contentKey="merlionBonusTrackApp.product.delete.question" interpolate={{ id: productEntity.id }}>
